...
class Cekdl extends CI_Controller
{
    ...
    public function cekberangkat_proses()
    {
        ...
        if ($this->input->post('jenis') == 'DLPP' and $this->input->post('jenis') == 'TAPP' and $this->input->post('jamberangkat') <= $um['um1']) {
            $this->db->set('um1', 'YA');
            $this->db->where('id', $this->input->post('id'));
            $this->db->update('perjalanan');
        };
        if ($this->input->post('jenis') == 'DLPP' and $this->input->post('jenis') == 'TAPP' and $this->input->post('jamberangkat') <= $um['um2']) {
            $this->db->set('um2', 'YA');
            $this->db->where('id', $this->input->post('id'));
            $this->db->update('perjalanan');
        };
    ...
    public function cekkembali_proses()
    {
        ...
        $um = $this->db->get_where('perjalanan_um', ['id' =>  '1'])->row_array();
        if ($this->input->post('jenis') == 'DLPP' and $this->input->post('jamberangkat') <= $um['um3'] and $this->input->post('jamkembali') >= $um['um3']) {
            $this->db->set('um3', 'YA');
            $this->db->where('id', $this->input->post('id'));
            $this->db->update('perjalanan');
        };
        if ($this->input->post('jenis') == 'DLPP' and $this->input->post('jamkembali') >= $um['um4']) {
            $this->db->set('um4', 'YA');
            $this->db->where('id', $this->input->post('id'));
            $this->db->update('perjalanan');
        };
