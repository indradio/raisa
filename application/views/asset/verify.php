        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        <?= form_open_multipart('asset/verify_proses'); ?>
                        ...
                        <div class="modal-footer justify-content-end">
                            <a href="<?= base_url('f221/asset'); ?>" class="btn btn-link">Kembali</a>
                            <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#reOpname" >REOPNAME</a>
                            <button type="submit" class="btn btn-success btn-wd">VERIFIKASI</button>
                        </div>
                        </form>
                    </div>
                </div>
...
<!-- end content-->
<!-- Modal -->
<div class="modal fade" id="reOpname" tabindex="-1" role="dialog" aria-labelledby="reOpnameTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header justify-content-center">
        <h5 class="modal-title" id="reOpnameTitle">Kamu yakin mau re-Opname?</h5>
        </button>
      </div>
      <form id="TypeValidation" class="form-horizontal" action="<?= base_url('asset/reopname_proses'); ?>" method="post">
        <div class="modal-body">
        <input class="form-control" type="hidden" name="id" id="id" value="<?= $asset['id']; ?>"/>
        <input class="form-control" type="hidden" name="role" id="role" value="fac"/>
        </div>
        <div class="modal-footer justify-content-center">
            <button type="submit" class="btn btn-wd btn-success">YA!</button>
