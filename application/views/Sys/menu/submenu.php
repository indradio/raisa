    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="toolbar">
            <a href="<?= base_url('sys/menu'); ?>" class="btn btn-success btn-sm">Back</a>
              <!--        Here you can write extra buttons/actions for the toolbar              -->
              
            </div>
            <div class="material-datatables">
              <table id="dt-menu" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>title</th>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#dt-menu').DataTable({
            ...
            processing: true,
            ajax: {
                    "url"   : "<?= site_url('sys/get_data/user_submenu') ?>",
                    "type"  : "POST",
