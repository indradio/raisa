...
if($lembur['durasi'] < '03:00:00' and $lembur['durasi_aktual'] >= '06:00:00')
{
      ...
      $pdf->Cell(78,5,'DISETUJUI',1,1,'C',1);
       //GA & HR 
...
else if ($lembur['durasi'] >= '03:00:00' and $lembur['durasi_aktual'] >= '06:00:00') 
{
      ...
      //TGL-sect-realisasi
      $pdf->Cell(267, 5, 'Disetujui',0, 0, 'C');
...
/********************************************************************************************************/
      if($lembur['durasi'] < '03:00:00' and $lembur['durasi_aktual'] >= '03:00:00')
            {
                  $pdf->Cell(44,5,'DITERIMA',1,0,'C',1);
                  $pdf->Cell(78,5,'DISETUJUI',1,0,'C',1);
                  $pdf->Cell(78,5,'DISETUJUI',1,1,'C',1);
                  //GA & HR
                  $pdf->Cell(22,5, 'GA5',1,0,'C',1);
                  $pdf->Cell(22,5, 'HR',1,0,'C',1);
                  //sect, dept, div, coo
...
/********************************************************************************************************/      
      // else if ($lembur['durasi'] >= '03:00:00' and $lembur['durasi_aktual'] >= '03:00:00')
      //       {
      //             $pdf->Cell(44,5,'DITERIMA',1,0,'C',1);
      //             $pdf->Cell(78,5,'DISETUJUI',1,0,'C',1);
      //             $pdf->Cell(78,5,'DISETUJUI',1,1,'C',1);
      //             //GA & HR
      //             $pdf->Cell(22,5, 'GA6',1,0,'C',1);
      //             $pdf->Cell(22,5, 'HR',1,0,'C',1);
      //             //sect, dept, div, coo
      //             $pdf->Cell(25,5, $n1['nama'],1,0,'C',1);
      //             $pdf->Cell(25,5, $n2['nama'],1,0,'C',1);
...
/********************************************************************************************************/      
 ...
 //#-> KURANG DARI 3 JAM           
/********************************************************************************************************/      
else if ($lembur['dept_id'] > '0' AND $lembur['durasi'] < '03:00:00' and $lembur['durasi_aktual'] < '03:00:00')
      {
...
//#-> KURANG DARI 3 JAM  DAN TIDAK ADA DEPT.HEAD       
/********************************************************************************************************/      
else if ($lembur['dept_id'] == '0' AND $lembur['durasi'] < '03:00:00' AND $lembur['durasi_aktual'] < '03:00:00')
      {
      ...
      $pdf->Cell(44,5,'',0,0,'C',1);
      $pdf->Cell(56,5,'DISETUJUI',1,0,'C',1);
      $pdf->Cell(22,5,'DITERIMA-QC',1,0,'C',1);
