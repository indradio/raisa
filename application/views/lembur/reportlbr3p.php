<?php
      ...
      $pdf->Cell(185,15,'RENCANA / 3 LAPORAN LEMBUR',0,1,'C');
      ...
      $pdf->Cell(18,5, date('H:i', strtotime($lembur['durasi'])),1,0,'C',0);
      ...
      $pdf->Cell(18,5, date('H:i', strtotime($lembur['durasi_aktual'])),1,1,'C',0);
      $pdf->Cell(56,5,'',0,1,0);
