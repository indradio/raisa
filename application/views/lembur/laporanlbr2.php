<?php
      ...
      $pdf->Cell(26,7,' KATEGORI',1,0,'C',1);
      $pdf->Cell(24,7,'COPRO',1,0,'C',1);
      $pdf->Cell(69,7,' AKTIVITAS LEMBUR',1,0,'C',1);
      ...
      $pdf->Cell(69,5,'',1,0,'C',1);
      $pdf->Cell(75,5,'',1,0,'C',1);
      $pdf->SetFont('Arial','',5);


      $pdf->Cell(56,5,'',0,0,'C',1);
      $pdf->Cell(45,5,'DISETUJUI',1,0,'C',1);
      $pdf->Cell(24,5,'DITERIMA',1,0,'C',1);
      
      $pdf->Cell(49,5,'DISETUJUI',1,0,'C',1);
      $pdf->Cell(26,5,'DITERIMA',1,1,'C',1);
      
      $pdf->Cell(56,5,'',0,0,'C',1);
      $pdf->Cell(23,7,'KEPALA SEKSI',1,0,'C',1);
      $pdf->Cell(24,7,'KEPALA DEPT.',1,0,'C',1);
      $pdf->Cell(22,7,'GA',1,0,'C',1);
      $pdf->Cell(25,7,'KEPALA SEKSI',1,0,'C',1);
      $pdf->Cell(24,7,'KEPALA DEPT.',1,0,'C',1);
      $pdf->Cell(26,7,'PERSONALIA',1,1,'C',1);
