<?php
      ...
      $pdf->Cell(29,7,'MULAI',1,0,'C',1);
      $pdf->Cell(29,7,'SELESAI',1,0,'C',1);
      $pdf->Cell(11,7,'JML.JAM',1,0,'C',1);
      ...
      $pdf->Cell(29,5, date('H:i', strtotime($lembur['tglmulai'])),1,0,'C',1);
      $pdf->Cell(29,5, date('H:i', strtotime($lembur['tglselesai'])),1,0,'C',1);
      $pdf->Cell(11,5, date('H:i', strtotime($lembur['durasi'])),1,0,'C',1);
      ...
      $pdf->Cell(11,5, date('H:i', strtotime($lembur['durasi_aktual'])),1,1,'C',0);
      $pdf->Cell(56,5,'',0,1,0);
