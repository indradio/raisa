                            ...
                            <table id="dtproject" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($project as $p) : 
                                        ...
                                        $mh_total_persen = @ (($mh_total/$p['mh_budget'])*100);
                                        ...
                                        <?php } ?>
                                            ...
                                            <td class="text-center"><?= number_format((float)$p['mh_budget'], 1, ',', '');?></td>
                                            <td class="text-center"><?= number_format((float)$mh_total, 1, ',', '');?></td>
                                            <td class="text-center"><?= number_format((float)$mh_total_persen, 1, ',', '');?>%</td>
                                            <?php if ($mh_remains>0){
                                                echo '<td class="text-success text-center">'.number_format((float)$mh_remains, 1, ',', '').'</td>';
                                                echo '<td class="text-success text-center">'.number_format((float)$mh_remains_persen, 1, ',', '').'%</td>';
                                            }elseif ($mh_remains<0){
