...
$pdf->Cell(170, 5, 'NO RESERVASI : ' . $reservasi['id'], 0, 1, 'C');
...
$pdf->Cell(170, 5, $reservasi['tujuan'], 0, 1);
$pdf->Cell(37, 5, 'Keperluan                                      : ', 0, 0);
$pdf->Cell(170, 5, $reservasi['keperluan'], 0, 1);
$pdf->Cell(37, 5, 'Berangkat                                      : ', 0, 0);
$pdf->Cell(170, 5, ''. date('d M Y', strtotime($reservasi['tglberangkat'])).' - '.date('H:i', strtotime($reservasi['jamberangkat'])), 0, 1);
$pdf->Cell(37, 5, 'Kembali                                        : ', 0, 0);
$pdf->Cell(170, 5, ''. date('d M Y', strtotime($reservasi['tglkembali'])).' - '.date('H:i', strtotime($reservasi['jamkembali'])), 0, 1);
...
$pdf->Cell(63, 5, $reservasi['akomodasi'] , 0, 0);
$pdf->Cell(9, 5, '' , 0, 1);
...
if ($reservasi['penginapan'])
{
    ...
    $pdf->Cell(63, 5, $reservasi['penginapan'].', ' .$reservasi['lama_menginap'].' Malam / Kelas.................................', 0, 0);
    $pdf->Cell(9, 5, '' , 0, 1);
}else{
    $pdf->Cell(5, 4.5, '' , 1, 0);
