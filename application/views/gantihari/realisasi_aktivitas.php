            ...
            <div class="col-md-12 align-content-start">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Realisasi Aktivitas Ganti Hari</h4>
                    </div>
                    <form class="form" method="post" action="<?= base_url('gantihari/ajukan_realisasi'); ?>">
                        <div class="card-body">
                            <div class="row col-md-12">
                                <div class="row col-md-6">
                                    ...
                                    <label class="col-ml-5 col-form-label">Tanggal Mulai</label>
                                        <div class="col-md-7">
                                            <div class="form-group has-default">
                                                <input type="text" class="form-control datetimepicker disabled" placeholder="With Material Icons" id="tglmulai" name="tglmulai" value="<?= $gantihari['tglmulai_aktual']; ?>">
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group has-default">
                                                <input type="text" class="form-control datetimepicker disabled" id="tglselesai_aktual" name="tglselesai_aktual" value="<?= $gantihari['tglselesai_aktual']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-12">
                                        <label class="col-ml-5 col-form-label">Durasi Ganti Hari</label>
                                            <div class="col-md-7">
                                                <div class="form-group has-default">
                                                    <input type="text" class="form-control disabled" id="durasi" name="durasi" value="<?= date('H:i', strtotime($gantihari['durasi_aktual'])).' Jam / '. $gantihari['aktivitas']; ?> Aktivitas">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                            ...
                            <div class="material-datatables">
                                    ...
                                    <tbody>
                                        <?php foreach ($aktivitas_gantihari as $a) : ?>
                                            <tr>
                                                ...
                                                <td><?= $a['durasi']; ?> jam</td>
                                                <td class="text-right">
                                                    <?php if ($gantihari['status'] == '4' and $a['status']== '1') { ?>
                                                    ...
                                                    <?php } else if($gantihari['status'] == '4' and $a['status']!= '1'){ ?>
                                                    ...
                                                    <?php }; ?>
                                                        <a href="<?= base_url('gantihari/hapus_aktivitas_realisasi/') . $a['id']; ?>" class="badge badge-pill badge-danger btn-sm btn-bataldl">Batalkan</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                        ...
                                        <p class="mb-0">1. GANTI HARI ini sudah termasuk aktivitas <mark>ISTIRAHAT</mark>.</p>
                                        <p class="mb-0">2. GANTI HARI ini sudah termasuk <mark>PERJALANAN</mark> (jika dinas luar).</p>
                                        <p class="mb-0">3. Durasi <mark>REALISASI GANTI HARI</mark> sudah sesuai dengan durasi lembur aktual yang akan diproses oleh HR.</p>
                                    </p>
                                ...
                                $ada_aktivitas = $this->db->get('aktivitas_gantihari')->row_array();
                                if ($ada_aktivitas) {
                                    $this->db->where('link_aktivitas', $gantihari['id']);
                                    $belum_dikerjakan = $this->db->get_where('aktivitas_gantihari', ['status' => '1'])->row_array();
                                    if ($belum_dikerjakan) { ?>
                                ...
                                <a href="<?= base_url('gantihari/realisasi/') ?>" class="btn btn-sm btn-default" role="button">Kembali</a>
                            </div>
                        </div>
                        <!-- end content-->
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('gantihari/update_aktivitas_realisasi'); ?>">
            ...
            <div class="card card-signup card-plain">
                <div class="modal-header">
                    <div class="card-header card-header-primary text-center">
                        ...
                        <h4 class="card-title">AKTIVITAS GANTI HARI</h4>
                    </div>
                </div>
                <form class="form" method="post" action="<?= base_url('gantihari/tambah_aktivitas_realisasi'); ?>">
                    <div class="modal-body">
                        <div class="row" hidden>
                            <label class="col-md-4 col-form-label">Lembur ID</label>
                            <div class="col-md-7">
            ...
            <div class="card card-signup card-plain">
                <div class="modal-header">
                    <div class="card-header card-header-primary text-center">
                        ...
                        <h4 class="card-title">UBAH JAM GANTI HARI</h4>
                    </div>
                </div>
                <form class="form-horizontal" method="post" action="<?= base_url('gantihari/gtJamRelalisai'); ?>">
                        <div class="modal-body">
                        <div class="card-body">
                            <div class="row" hidden>
                                <label class="col-md-5 col-form-label">Lembur ID</label>
        ...
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('lembur/batal_lembur'); ?>">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="submit" class="btn btn-danger">BATALKAN GANTI HARI INI!</button>
                    </div>
                </form>
            </div>
        </div>
