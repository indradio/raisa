      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">Persetujuan Ganti Hari</h4>
          </div>
          <div class="card-body">
            <div class="toolbar">
              ...
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <tbody>
                  <?php foreach ($rencana as $l) : ?>
                      <tr onclick="window.location='<?= base_url('gantihari/persetujuan_rencana/') . $l['id']; ?>'" >
            ...
            <div class="material-datatables">
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr onclick="window.location='<?= base_url('gantihari/persetujuan_realisasi/') . $l['id']; ?>'" >
                      <td><?= $l['nama']; ?> <small>(<?= $l['id']; ?>)</small></td>
