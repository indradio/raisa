                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="toolbar text-right mb-2">
                            ...
                            <a href="#" class="btn btn-primary" role="button" aria-disabled="false" data-toggle="modal" data-target="#tambahLembur">Rencana Ganti Hari</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('gantihari/tambah_harilain'); ?>">
                    <div class="modal-body">
                        <div class="row">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?= base_url('gantihari/rencana'); ?>" class="btn btn-default">Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
