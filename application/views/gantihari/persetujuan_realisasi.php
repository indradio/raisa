            ...
            <div class="col-md-12 align-content-start">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Persetujuan Realisasi Ganti Hari</h4>
                    </div>
                    <form class="form" method="post" action="<?= base_url('gantihari/setujui_realisasi'); ?>">
                    <div class="card-body">
                    <div class="row col-md-12">
                                ...
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group has-default">
                                            <input type="text" class="form-control disabled" id="nama" name="nama" value="<?= date('d-M H:i', strtotime($gantihari['tglmulai_aktual'])); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row col-md-12">
      ...
      <div class="card card-signup card-plain">
        ...
        <form class="form" method="post" action="<?= base_url('gantihari/batal_lembur'); ?>">
          <div class="modal-body">
            ...
            <textarea rows="2" class="form-control" name="catatan" id="catatan" placeholder="Keterangan Pembatalan Ganti Hari" required></textarea>
          </div>
          <div class="modal-footer justify-content-center">
            <button type="submit" class="btn btn-rose">BATALKAN REALISASI LEGANTI HARI!</button>
          </div>
        </form>
      </div>
    </div>
