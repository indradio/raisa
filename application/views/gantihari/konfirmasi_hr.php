        ...
        <div class="row">
            <div class="col-md-12 align-content-start">
                <div class="card">
                    ...
                    <form class="form-horizontal" method="post" action="<?= base_url('gantihari/submit_konfirmasi_hr'); ?>">
                        <div class="card-body">
                            <div class="row col-md-12">
                                    ...
                                    <div class="row col-12">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group has-default">
                                                <input type="text" class="form-control disabled" id="nama" name="nama" value="<?= $gantihari['nama']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-12">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('gantihari/batal_gantihari'); ?>">
                    <div class="modal-body">
