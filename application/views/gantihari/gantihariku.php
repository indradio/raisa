            ...
            <div class="col-md-12 align-content-start">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Data Ganti Hari</h4>
                    </div>
                    <form class="form" method="post" action="#">
                        <div class="card-body">
                            <div class="row col-md-12">
                                <div class="row col-md-6">
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group has-default">
                                                <input type="text" class="form-control datetimepicker disabled" id="tglmulai_aktual" name="tglmulai_aktual" value="<?= $gantihari['tglmulai_aktual']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-12">
                            ...
                            <div class="row col-md-6">
                                <div class="row col-md-12">
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group has-default">
                                                <input type="text" class="form-control disabled" id="durasi" name="durasi" value="<?= $gantihari['durasi_aktual']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-12">
                            ...
                            <div class="material-datatables">
                                ...
                                <a href="<?= base_url('gantihari/index/') ?>" class="btn btn-default" role="button">Kembali</a>
                            </div>
                        </div>
                        <!-- end content-->
                </div>
