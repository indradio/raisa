            ...
            <div class="col-md-12 align-content-start">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Persetujuan Rencana Ganti Hari</h4>
                    </div>
                    <form class="form-horizontal" method="post" action="<?= base_url('gantihari/setujui_rencana'); ?>">
                        <div class="card-body">
                            <div class="row col-md-12">
                                ...
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group has-default">
                                            <input type="text" class="form-control disabled" id="nama" name="nama" value="<?= date('d-M H:i', strtotime($gantihari['tglmulai'])); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row col-md-12">
                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover"  cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    <?php foreach ($aktivitas_gantihari as $a) : ?>
                                        <tr>
                                            ...
                                            <?php if ($gantihari['status'] !='7'){ ?>
                                                ...
                                                <a href="<?= base_url('gantihari/hapus_aktivitas/') . $a['id']; ?>" class="btn btn-sm btn-round btn-danger btn-sm btn-bataldl">HAPUS</a> 
                                            <?php }else{ ?>
                                                ...
                                                <a href="<?= base_url('gantihari/hapus/') . $a['id']; ?>" class="btn btn-sm btn-round btn-danger btn-sm disabled">HAPUS</a> 
                                            <?php }; ?>   
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                ...
                                <!-- Button SUBMIT -->
                                <?php if ($gantihari['aktivitas_rencana'] == 0) {
                                ...
                                <a href="<?= base_url('gantihari/persetujuan_gantihari/') ?>" class="btn btn-sm btn-default" role="button">Kembali</a>
                         </div>
                    </div>
                    <!-- end content-->
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('gantihari/update_aktivitas'); ?>">
                <div class="modal-body">
                        <div class="row" hidden>
    ...
    <div class="modal-content">
      <div class="card card-signup card-plain">
        ...
        <form class="form" method="post" action="<?= base_url('gantihari/batal_gantihari'); ?>">
          ...
          <div class="modal-footer justify-content-center">
            <button type="submit" class="btn btn-rose">BATALKAN GANTI HARI INI!</button>
          </div>
        </form>
      </div>
    </div>
