  ...
  <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-6">
                                <?php 
                                    ...
                                    $total_lembur = $this->db->get('gantihari');
                                ?>
                            <div class="card card-stats">
                              ...
                              <div class="card-footer">
                                <div class="stats">
                               TOTAL Ganti Hari kamu di bulan ini
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="card card-stats">
                              ...
                              <div class="card-footer">
                                <div class="stats">
                                 Total JAM GANTI HARI Kamu bulan ini
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <?php 
                            ...
                            <div class="card card-stats">
                              ...
                              <div class="card-footer">
                                <div class="stats">
                                Total TUL GANTI HARI Kamu bulan ini
                                </div>
                              </div>
                            </div>
                          </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">DATA GANTI HARI KERJA</h4>
          </div>
          <div class="card-body">
            <div class="toolbar">
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <?php }else if ($l['status'] == '0' or $l['status'] == '7' or $l['status'] == '8' or $l['status'] == '9') { ?>
                            <a href="<?= base_url('gantihari/gantihariku/') . $l['id']; ?>" class="badge badge-pill badge-success">Detail</a>
                          <?php } else { ?>
                              <a href="<?= base_url('gantihari/rencana_aktivitas/') . $l['id']; ?>" class="badge badge-pill badge-success">Detail</a>
                          <?php }; ?>
                      ...
                      <td class="text-right">
                          <?php if ($l['status'] == '9' ) { ?>
                            <a href="<?= base_url('gantihari/reportgh/') . $l['id']; ?>" class="btn btn-link btn-warning btn-just-icon edit" target="_blank"><i class="material-icons">dvr</i></a>
                          <?php } else { ?>
                            <a href="<?= base_url('gantihari/reportgh/') . $l['id']; ?>" class="btn btn-link btn-warning btn-just-icon edit disabled"><i class="material-icons">dvr</i></a>
                          <?php }; ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
