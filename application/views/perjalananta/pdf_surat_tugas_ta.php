...
$peserta = $this->db->get_where('perjalanan_anggota', ['reservasi_id' => $perjalanan['reservasi_id']])->result_array();
$no = 1;
...
$jadwal = $this->db->get_where('perjalanan_jadwal', ['reservasi_id' => $perjalanan['reservasi_id']])->result_array();
$nomor = 1;
foreach ($jadwal as $j) :
