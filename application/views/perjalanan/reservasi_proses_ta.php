            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <h4>Penting : </h4>
                        1. Pastikan <mark><b>KENDARAAN</b></mark> sudah benar. 
                        </p>
                                        <div class="form-group has-default">
            ...
            <form class="form" method="post" action="<?= base_url('perjalanandl/prosesdl2'); ?>">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group has-default">
                                <input type="number" class="form-control" id="kasbon" name="kasbon" value="0" required="true" autofocus/>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    //         document.getElementById("nopol").style.display = val != 'Taksi' ? "block" : 'none';
