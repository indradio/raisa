                  ...
                  <div class="row">
                      ...
                      <div class="col-md-5">
                        ...
                        <!--        Here you can write extra buttons/actions for the toolbar              -->
                          <a href="#" class="btn btn-primary" role="button" aria-disabled="false" data-toggle="modal" data-target="#tambahPesertaTA">Tambah</a>
                        </div>
                          ...
                          <table id="#" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <?php
                                ...
                                <tr>
                                  ...
                                  <td class="text-right"><a href="<?= base_url('reservasi/hapusanggota/') . $reservasi['id'] . '/' . $p['karyawan_inisial']; ?>" class="btn btn-link btn-danger btn-just-icon remove"><i class="material-icons">close</i></a></td>
                                </tr>
                                <?php 
                                $no++;
                                endforeach; ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-10">
                          <div class="form-group has-default">
                              ...
                              <a href="<?= base_url('reservasi/ta/'.$reservasi['id']); ?>" class="btn btn-fill btn-info" target="_blank">Cetak Surat Tugas</a>
...
<div class="modal fade" id="tambahPesertaTA" tabindex="-1" role="dialog" aria-labelledby="tambahPesertaTATitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                <div class="modal-header">
                ...
                <form class="form" method="post" action="<?= base_url('reservasi/tambahanggota'); ?>">
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="row">
