        ...
        <form id="timePrecense" class="form" method="post" action="<?= base_url('dirumahaja/submit'); ?>">
          <div class="card ">
            ...
            <div class="alert-default" role="alert">
              ...
              <div class="form-group">
                <label for="b1" class="bmd-label-floating">B1. Anggota keluarga dalam satu rumah sedang mengalami sakit dengan gejala berikut <b>Demam, Batuk, Nyeri Tenggorokan, Atau Sesak Nafas</b></label>
