    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('Projectbudget/updatedetail'); ?>">
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-default">
                                        <input type="text" class="form-control " id="biaya_est" name="biaya_est" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row" >
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-default">
                                        <input type="text" class="form-control disabled" id="biaya_act" name="biaya_act">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
