                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control datepicker" name="tgl_cuti1" id="tgl_cuti1" required/>
                          </div>
                      </div>
                      <div class="col-md-12">
                          <div class="form-group">
                              <label class="bmd-label">Sampai*</label></br>
                              <input type="text" class="form-control datepicker" name="tgl_cuti2" id="tgl_cuti2" required/>
                          </div>
                      </div>
                      <div class="col-md-12">
                          <div class="form-group">
