                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <?php if ($row['saldo_digunakan']==0): ?>
                          ...
                          <?php else: ?>
                            <a href="<?= base_url('cuti/hr_saldo_riwayat/'.$row['id']); ?>" class="btn btn-link btn-info btn-just-icon" role="button" aria-disabled="false"><i class="material-icons">plagiarism</i></a>
                          <?php endif; ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
