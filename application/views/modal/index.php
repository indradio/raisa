...
<!-- Modal Ubah Karyawan -->
<div class="modal fade" id="karyawanUbah" tabindex="-1" role="dialog" aria-labelledby="karyawanUbahTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                <div class="modal-header">
                    <div class="card-header card-header-primary text-center">
                        ...
                        <h4 class="card-title">Ubah Data Karyawan Baru</h4>
                    </div>
                </div>
                <?= form_open_multipart('hr/ubah'); ?>
                <div class="modal-body">
                    <div class="card-body">
                        <div class="row">
                            <label class="col-md-3 col-form-label">NPK</label>
